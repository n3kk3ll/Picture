...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_isRussianLetters__WEBPACK_IMPORTED_MODULE_4__["default"])("[name=name]");
  Object(_modules_isRussianLetters__WEBPACK_IMPORTED_MODULE_4__["default"])("[name=message]"); // Show various styles (optional)
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(trigger, menuSelector) {
...
var calcScrollWidth = function calcScrollWidth() {
  ...
  var scrollWidth = block.offsetWidth - block.clientWidth;
  block.remove();
  return scrollWidth;
};
...
var forms = function forms() {
  ...
  var clearInputs = function clearInputs() {
    ...
    uploadInputs.forEach(function (upload) {
  ...
  uploadInputs.forEach(function (upload) {
    upload.addEventListener("input", function () {
      var uploadedFileName = upload.files[0].name.split('.'),
          uploadedFileNameDisplayed = uploadedFileName[0].length > 6 ? "".concat(uploadedFileName[0].substring(0, 6), "...").concat(uploadedFileName[1]) : "".concat(uploadedFileName[0], ".").concat(uploadedFileName[1]);
...
/***/ "./src/js/modules/isRussianLetters.js":
/*!********************************************!*\
  !*** ./src/js/modules/isRussianLetters.js ***!
  \********************************************/
/*! exports provided: default */
...
var isRussianLetters = function isRussianLetters(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (isRussianLetters);
...
var modals = function modals() {
  ...
  function handleModal(triggerSelector, modalSelector, closeBtn) {
    ...
    function openModal() {
      ...
      giftIcon.style.marginRight = "".concat(scroll, "px");
    }
  ...
  function showModalAfterTime(modal, time) {
    setTimeout(function () {
      var display;
      document.querySelectorAll("[data-modal]").forEach(function (popup) {
...
var showCards = function showCards(trigger, styles) {
